...
export class AccountController {
    ...
    async delete(req: Request, res: Response): Promise<any> {
        const account = await this.accountService.delete(req.userId, req.params.accountNumber as string);
        return res.status(200).json({ account, message: "account deleted successfully" });
    }
