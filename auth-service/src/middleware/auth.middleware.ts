...
const publicRoutes = ['/api/v1/auth/login', '/api/v1/auth/login/', '/api/v1/auth/register', '/api/v1/auth/register/', '/', '/health', '/api/v1/auth/health', '/api/v1/auth/health/', '/api/v1/auth/logout', '/api/v1/auth/logout/'];
